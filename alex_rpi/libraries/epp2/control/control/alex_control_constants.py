...
class TCommandType(enum.Enum):
    ...
    Attributes:
        COMMAND_FORWARD (0): Command to move the device forward.
        COMMAND_REVERSE (1): Command to move the device in reverse.
        COMMAND_TURN_LEFT (2): Command to turn the device to the left.
        COMMAND_TURN_RIGHT (3): Command to turn the device to the right.
        COMMAND_STOP (4): Command to stop the device.
        COMMAND_GET_STATS (5): Command to retrieve the device's statistics.
        COMMAND_CLEAR_STATS (6): Command to clear the device's statistics.
        COMMAND_OPEN_CLAW (7): Command to open the claw
        COMMAND_CLOSE_CLAW (8): Command to open the claw
    """
    COMMAND_FORWARD = 0
    COMMAND_REVERSE = 1
    COMMAND_TURN_LEFT = 2
...
PAYLOAD_PACKET_SIZE = ctypes.sizeof(TPacket) #100
